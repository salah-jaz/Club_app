...
function EditSchedule() {
  ...
  const sch = useStore((state) => state.schedules.find((x) => x.id === id));
            ...
            <div className="space-y-1.5">
              ...
              {f.location || (locations && locations.length > 0) ? (
                <div className="relative">
                  ...
                  >
                    {(locations && locations.length > 0 ? locations : [f.location]).map((l) => (
